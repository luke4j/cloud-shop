...
create table TU_Role (id bigint not null auto_increment, b_isDel Boolean default false not null, b_wtime datetime(6) not null, name varchar(40), bz varchar(80), comId bigint, primary key (id)) ;
