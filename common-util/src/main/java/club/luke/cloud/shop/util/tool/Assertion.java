...
public class Assertion {
    public static void Error(){
        throw AppRuntimeException.create("还没有写代码") ;
    }

    public static void Error(String msg) {
        throw AppRuntimeException.create(msg) ;
    }
    ...
    public static void True(Boolean obj,String msg){
        if(obj.equals(true)) throw AppRuntimeException.create(msg);
    }
    ...
    public static void False(Boolean obj,String msg){
        if(obj.equals(false)) throw AppRuntimeException.create(msg);
    }
    ...
    public static void Empty(Object obj,String msg){
        if(obj!=null)  throw AppRuntimeException.create(msg) ;
    }
    ...
    public static void NotEquals(Object obj1,Object obj2,String msg){
        ...
        if(obj1.equals(obj2)) throw AppRuntimeException.create(msg);
    }
